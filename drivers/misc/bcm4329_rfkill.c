...
static struct wireless_power_control *bcm4329_rfkill_enable_power = NULL;
...
static int bcm4329_rfkill_probe(struct platform_device *pdev)
{
	...
	bcm4329_rfkill_enable_power = pdev->dev.platform_data;
...
free_bcm_res:
	...
	if (bcm4329_rfkill_enable_power)
		bcm4329_rfkill_enable_power = NULL;
