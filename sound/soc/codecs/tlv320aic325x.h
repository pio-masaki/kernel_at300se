...
/******************** Page 8 Registers **************************************/
#define PAGE_8				1024
#define ADC_L_N0_BIQUAD_A_COEFF_REG_1              (PAGE_8+36)
#define ADC_L_N0_BIQUAD_A_COEFF_REG_2              (PAGE_8+37)
#define ADC_L_N0_BIQUAD_A_COEFF_REG_3              (PAGE_8+38)
#define ADC_L_N1_BIQUAD_A_COEFF_REG_1              (PAGE_8+40)
#define ADC_L_N1_BIQUAD_A_COEFF_REG_2              (PAGE_8+41)
#define ADC_L_N1_BIQUAD_A_COEFF_REG_3              (PAGE_8+42)
#define ADC_L_N2_BIQUAD_A_COEFF_REG_1              (PAGE_8+44)
#define ADC_L_N2_BIQUAD_A_COEFF_REG_2              (PAGE_8+45)
#define ADC_L_N2_BIQUAD_A_COEFF_REG_3              (PAGE_8+46)
#define ADC_L_D1_BIQUAD_A_COEFF_REG_1              (PAGE_8+48)
#define ADC_L_D1_BIQUAD_A_COEFF_REG_2              (PAGE_8+49)
#define ADC_L_D1_BIQUAD_A_COEFF_REG_3              (PAGE_8+50)
#define ADC_L_D2_BIQUAD_A_COEFF_REG_1              (PAGE_8+52)
#define ADC_L_D2_BIQUAD_A_COEFF_REG_2              (PAGE_8+53)
#define ADC_L_D2_BIQUAD_A_COEFF_REG_3              (PAGE_8+54)


#define ADC_L_N0_BIQUAD_B_COEFF_REG_1              (PAGE_8+56)
#define ADC_L_N0_BIQUAD_B_COEFF_REG_2              (PAGE_8+57)
#define ADC_L_N0_BIQUAD_B_COEFF_REG_3              (PAGE_8+58)
#define ADC_L_N1_BIQUAD_B_COEFF_REG_1              (PAGE_8+60)
#define ADC_L_N1_BIQUAD_B_COEFF_REG_2              (PAGE_8+61)
#define ADC_L_N1_BIQUAD_B_COEFF_REG_3              (PAGE_8+62)
#define ADC_L_N2_BIQUAD_B_COEFF_REG_1              (PAGE_8+64)
#define ADC_L_N2_BIQUAD_B_COEFF_REG_2              (PAGE_8+65)
#define ADC_L_N2_BIQUAD_B_COEFF_REG_3              (PAGE_8+66)
#define ADC_L_D1_BIQUAD_B_COEFF_REG_1              (PAGE_8+68)
#define ADC_L_D1_BIQUAD_B_COEFF_REG_2              (PAGE_8+69)
#define ADC_L_D1_BIQUAD_B_COEFF_REG_3              (PAGE_8+70)
#define ADC_L_D2_BIQUAD_B_COEFF_REG_1              (PAGE_8+72)
#define ADC_L_D2_BIQUAD_B_COEFF_REG_2              (PAGE_8+73)
#define ADC_L_D2_BIQUAD_B_COEFF_REG_3              (PAGE_8+74)
...
#define ADC_R_N0_BIQUAD_A_COEFF_REG_1              (PAGE_9+44)
#define ADC_R_N0_BIQUAD_A_COEFF_REG_2              (PAGE_9+45)
#define ADC_R_N0_BIQUAD_A_COEFF_REG_3              (PAGE_9+46)
#define ADC_R_N1_BIQUAD_A_COEFF_REG_1              (PAGE_9+48)
#define ADC_R_N1_BIQUAD_A_COEFF_REG_2              (PAGE_9+49)
#define ADC_R_N1_BIQUAD_A_COEFF_REG_3              (PAGE_9+50)
#define ADC_R_N2_BIQUAD_A_COEFF_REG_1              (PAGE_9+52)
#define ADC_R_N2_BIQUAD_A_COEFF_REG_2              (PAGE_9+53)
#define ADC_R_N2_BIQUAD_A_COEFF_REG_3              (PAGE_9+54)
#define ADC_R_D1_BIQUAD_A_COEFF_REG_1              (PAGE_9+56)
#define ADC_R_D1_BIQUAD_A_COEFF_REG_2              (PAGE_9+57)
#define ADC_R_D1_BIQUAD_A_COEFF_REG_3              (PAGE_9+58)
#define ADC_R_D2_BIQUAD_A_COEFF_REG_1              (PAGE_9+60)
#define ADC_R_D2_BIQUAD_A_COEFF_REG_2              (PAGE_9+61)
#define ADC_R_D2_BIQUAD_A_COEFF_REG_3              (PAGE_9+62)


#define ADC_R_N0_BIQUAD_B_COEFF_REG_1              (PAGE_9+64)
#define ADC_R_N0_BIQUAD_B_COEFF_REG_2              (PAGE_9+65)
#define ADC_R_N0_BIQUAD_B_COEFF_REG_3              (PAGE_9+66)
#define ADC_R_N1_BIQUAD_B_COEFF_REG_1              (PAGE_9+68)
#define ADC_R_N1_BIQUAD_B_COEFF_REG_2              (PAGE_9+69)
#define ADC_R_N1_BIQUAD_B_COEFF_REG_3              (PAGE_9+70)
#define ADC_R_N2_BIQUAD_B_COEFF_REG_1              (PAGE_9+72)
#define ADC_R_N2_BIQUAD_B_COEFF_REG_2              (PAGE_9+73)
#define ADC_R_N2_BIQUAD_B_COEFF_REG_3              (PAGE_9+74)
#define ADC_R_D1_BIQUAD_B_COEFF_REG_1              (PAGE_9+76)
#define ADC_R_D1_BIQUAD_B_COEFF_REG_2              (PAGE_9+77)
#define ADC_R_D1_BIQUAD_B_COEFF_REG_3              (PAGE_9+78)
#define ADC_R_D2_BIQUAD_B_COEFF_REG_1              (PAGE_9+80)
#define ADC_R_D2_BIQUAD_B_COEFF_REG_2              (PAGE_9+81)
#define ADC_R_D2_BIQUAD_B_COEFF_REG_3              (PAGE_9+82)
