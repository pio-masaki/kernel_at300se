...
/* Samsung DDR3L K3B2G0846D-HYH9 : SKU1 */
static const struct tegra_emc_table tostab12AL_emc_tables_k4b2g0846d_hyh9[] =
{
	{
		0x32,       /* Rev 3.2 */
	...
	},
	{
		...
		667000,     /* SDRAM frequency */
		{
			...
			0x00024000, /* EMC_DLL_XFORM_QUSE0 */
			0x00024000, /* EMC_DLL_XFORM_QUSE1 */
			0x00024000, /* EMC_DLL_XFORM_QUSE2 */
			0x00024000, /* EMC_DLL_XFORM_QUSE3 */
			0x00024000, /* EMC_DLL_XFORM_QUSE4 */
			0x00024000, /* EMC_DLL_XFORM_QUSE5 */
			0x00024000, /* EMC_DLL_XFORM_QUSE6 */
			0x00024000, /* EMC_DLL_XFORM_QUSE7 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS1 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS2 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS3 */
...
/* Hynix DDR3L H5TC2G83CFR-H9A : SKU2 */
static const struct tegra_emc_table tostab12AL_emc_tables_h5tc2g83cfr_h9a[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static void tostab12AL_init_emc(void) {
    u32 reg;
    int ram_id;
    ...
    switch (ram_id) {
        default:
        case 0:
            pr_info("%s: ram:Samsung K4B2G0846D-HYH9 667Mhz\n", __func__);
            emc_tables = tostab12AL_emc_tables_k4b2g0846d_hyh9;
            emc_tables_size = ARRAY_SIZE(tostab12AL_emc_tables_k4b2g0846d_hyh9);
            break;

        case 1:
            pr_info("%s: ram:Hynix H5TC2G83CFR-H9A 667Mhz\n", __func__);
            emc_tables = tostab12AL_emc_tables_h5tc2g83cfr_h9a;
            emc_tables_size = ARRAY_SIZE(tostab12AL_emc_tables_h5tc2g83cfr_h9a);
            break;
    }
